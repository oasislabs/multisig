...
## Introduction
This is an example service that implements transactions that require multiple signatures. In case where you may require that mulitple different parties sign off on a transaction before executing it, you can use this service to enforce that policy.
